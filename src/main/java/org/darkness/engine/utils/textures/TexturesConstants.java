...
public abstract class TexturesConstants {
    public static final int GRASS_TEXTURE = TexturesUtil.createTextureId("/textures/blocks/grass.png", TexturesUtil.LINEAR);
